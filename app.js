...
passport.use(new GoogleStrategy({
      ...
      callbackURL: "https://shareyoursecrets-nodeapp.herokuapp.com/auth/google/secrets",
            ...
            if(err){
                  ...
                  if(founduser){
                      ...
                      founduser.save(function(err){
                        if(err){
                              console.log(err);
                              console.log("Created Secret not saved");
                        }else{
                              console.log("Secret saved in User's Database");
                              res.redirect("/secrets")
                        }
                      })
                  }else{
                        console.log("Userid doesnt match with Database")
                  }
            }
      })
})
